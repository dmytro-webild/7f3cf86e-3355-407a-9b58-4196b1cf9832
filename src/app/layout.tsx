...
export const metadata: Metadata = {
  title: "Studio Beauty Boss Porto | Cabelo, Unhas & Cílios — 910 953 950",  description: "Salão de beleza completo no Porto com 5★ em 65 avaliações. Cabelo, unhas, pestanas e tratamentos faciais. Ambiente acolhedor na R. da Constituição 668. Ligue já!",  keywords: "salão de beleza Porto, cabeleireiro Porto, unhas Porto, extensões pestanas Porto, cílios Porto, tratamento facial Porto, beleza Porto",  metadataBase: new URL("https://studiobeautyboss.pt"),
  alternates: {
    canonical: "https://studiobeautyboss.pt"},
  openGraph: {
    title: "Studio Beauty Boss Porto | Cabelo, Unhas & Cílios",    description: "Salão de beleza completo com 5★ em 65 avaliações. Serviços premium num ambiente acolhedor",    url: "https://studiobeautyboss.pt",    siteName: "Studio Beauty Boss",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/waiting-room-with-chairs-blurred_1203-1402.jpg",        alt: "Studio Beauty Boss — Interior elegante"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Studio Beauty Boss Porto — 5★ Beleza Completa",    description: "Cabelo, unhas, cílios e tratamentos faciais com qualidade premium",    images: ["http://img.b2bpic.net/free-photo/waiting-room-with-chairs-blurred_1203-1402.jpg"],
  },
  robots: {
    index: true,
    follow: true,
